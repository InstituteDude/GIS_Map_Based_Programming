...
<qgis version="3.38.3-Grenoble">
  <identifier>Jln_Bengkayang_Km</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Jln_Bengkayang_Km</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" name="File Geodatabase Feature Class" description="" mimeType="" type="Local Area Network" format="" size=""/>
  </links>
  <dates/>
  <fees></fees>
