...
var CartoDBpositron_DE= L.tileLayer(mbUrlCartoDBpositron_DE, {maxZoom: 17, attribution: mbAttrCartoDBpositron_DE});
var OSM_DE = L.tileLayer(mbUrlOSM_DE, {maxZoom: 18, attribution: mbAttrOSM_DE});
...
var comp = new L.Control.Compass({autoActive: false, showDigit:false, position: 'topleft'});
map.addControl(comp);

//<!-- Scale Bar Bottom Left -->
var options = null;
var scale = L.control.betterscale({metric:true, imperial:false,position: 'bottomright'}).addTo(map);
...
//<!-- Lokasi kecamatan bengkayang dengan lingkaran -->
	 var circle1 = L.circle([0.8318646009953408,109.48562057427705], {
		 ...
		 .bindPopup("<b>Kecamatan Bengkayang</b><br/>Disini!").closePopup();

//		 <!-- Kantor Kelurahan Sebalo dengan lingkaran -->
		 var circle2 = L.circle([0.8336932954159717,109.4893265216038], {
			 color: '#800000',
			 fillColor: '#00FFFF',
			 fillOpacity: 0.3,
			 weight: 2,
			 ...
			 .bindPopup("<b>Kantor Kelurahan Sebalo</b><br/>Disini!").closePopup();

			 //<!-- Lokasi Kantor Kecamatan Teriak dengan lingkaran -->
			 var circle3 = L.circle([0.835309491540643,109.49032073369047], {
				  color: '#800000',
				  fillColor: '#00FFFF',
					 fillOpacity: 0.3,
					 weight: 2,
			  ...
			  .bindPopup("<b>Kantor Kecamatan Teriak</b><br/>Disini!").closePopup();
		 
		 //<!-- Lokasi Gunung bawang bengkayang dengan lingkaran -->
			  var circle4 = L.circle([0.8918905472133956,109.39684284322988], {
				   color: '#800000',
				   fillColor: '#00FFFF',
					  fillOpacity: 0.3,
					  weight: 2,
			   ...
			   .bindPopup("<b>Gunung Bawang bengkawang</b><br/>Disini!").closePopup();
...
//<!-- Lala Golden bengkayang dengan Kotak -->
	var kotak1 = [[0.8164495056577579,109.48820781929584], [0.8160199095172942,109.48889897887108]];
		L.rectangle(kotak1, {
		color: '#FD1C03',
		fillColor: '#ffb347',
		fillOpacity: 0.2,
	...
	.bindPopup("<b>Lala Golden Bengkayang").closePopup();
...
//<!-- SDN 09 Rangkang dengan Kotak -->  
	...
	.bindPopup("<b>SDN 09 Rangkang").closePopup();
...
.bindPopup("<b>Pangkalan Udara Harry Hadisoemantri</b><br />Disini!").closePopup();

//<!-- Gunung Apu dengan Kotak -->
var kotak4 = [[
	1.0339594203463918,
	109.49821409758107
	], [
...
.bindPopup("<b> Gunung Upu</b><br />Disini!").closePopup();
...
    var polyline2 = L.polyline([
	...
	//<!-- Posisi di WEBGIS untuk pencaharian -->
	var data = [
		{"loc":[0.8318646009953408,109.48562057427705], "title":"Kecamatan Bengkayang"},
		...
		{"loc":[0.8918905472133956,109.39684284322988], "title":"Gunung Bawang Bengkawang"},
		{"loc":[0.8164495056577579,109.48820781929584], "title":"Lala Golden Bengkayang"},
		{"loc":[0.848997, 109.500304], "title":"SDN 09 Rangkang"},
		{"loc":[1.083256, 109.693877], "title":"Pangkalan Udara Harry Hadisoemantri"},
		{"loc":[1.033306, 109.500004], "title":"Gunung Upu"},
